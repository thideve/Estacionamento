...
function up()
{
  ...
  if(greencar_y >=0){
    ...
    console.log("Quando a seta para cima for pressionada, x = " + greencar_x + " | y = " +greencar_y);
    uploadBackground();
    uploadGreenCar();
  }
}
...
function down()
{
  ...
  if(greencar_y <=400){
    greencar_y = greencar_y +10;
    console.log("Quando a seta para baixo for pressionada, x = " + greencar_x + " | y = " +greencar_y);
    uploadBackground();
    uploadGreenCar();
  }
}
...
function left()
{
  ...
  if(greencar_x >=0){
    ...
    console.log("Quando a seta para esquerda for pressionada, x = " + greencar_x + " | y = " +greencar_y);
    uploadBackground();
    uploadGreenCar();
  }
}
...
function right()
{
  ...
  if(greencar_x <=800){
    greencar_x = greencar_x +10;
    console.log("Quando a seta para direita for pressionada, x = " + greencar_x + " | y = " +greencar_y);
    uploadBackground();
    uploadGreenCar();
  }
}